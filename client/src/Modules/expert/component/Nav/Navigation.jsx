...
import YardIcon from "@mui/icons-material/Yard"; // Import YardIcon

import AssignmentIcon from "@mui/icons-material/Assignment"; // Import AssignmentIcon for Appointments
import QuestionAnswerIcon from "@mui/icons-material/QuestionAnswer"; // Import QuestionAnswerIcon for Queries
...
const Navigation = () => {
  ...
  useEffect(() => {
    ...
    if (currentRoute.includes("/expert/home")) {
      setActiveItem("Home");
    } else if (currentRoute.includes("/expert/appointments")) {
      setActiveItem("Appointments");
    } else if (currentRoute.includes("/expert/queries")) {
      setActiveItem("Queries");
    } else {
      setActiveItem("");
    }
  }, [location.pathname]);
  ...
  const sideBarList = [
    {
      title: "Dashboard", // Change title to Dashboard
      path: "/expert/home",
      icon: <DashboardIcon sx={{ fontSize: "14px", color: "white" }} />, // Use DashboardIcon
    },
    {
      title: "Appointments",
      path: "/expert/appointments",
      icon: <AssignmentIcon sx={{ fontSize: "14px", color: "white" }} />,
    },
    {
      title: "Queries",
      path: "/expert/queries",
      icon: <QuestionAnswerIcon sx={{ fontSize: "14px", color: "white" }} />,
    },
  ];
